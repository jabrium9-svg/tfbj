    ...
    <main className="min-h-screen bg-texture">
      ...
      <section className="min-h-[90vh] flex flex-col justify-center section-padding bg-fold-warmWhite">
        <div className="container-content text-center">
          ...
          {/* CTA */}
          <a href="https://app.jabrium.com?source=tfbj&leader=website" className="btn-primary">
      ...
      <section id="get-started" className="section-padding bg-fold-green">
        <div className="container-content text-center">
          ...
          <a href="https://app.jabrium.com?source=tfbj&leader=website" className="inline-flex items-center justify-center px-10 py-5 bg-fold-gold text-fold-green font-sans font-medium rounded-sm hover:bg-fold-goldMuted transition-colors duration-200 text-lg tracking-wide">
